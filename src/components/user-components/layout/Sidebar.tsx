...
const navItems: NavItem[] = [
  ...
  { label: 'Correction Request', path: '/user-dashboard/correction-request', icon: ClipboardEdit },
  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-[220px] bg-sidebar flex flex-col z-50">
      <div className="h-[52px] flex items-center px-5 border-b border-white/10">
        <span className="text-white font-bold text-sm tracking-tight">MedClock</span>
      </div>
