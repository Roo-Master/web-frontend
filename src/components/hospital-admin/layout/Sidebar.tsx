...
import {
  ...
  Clock, Activity, DollarSign, FileText, Bell, Cpu, Settings,
  ChevronRight, ChevronDown, HelpCircle, LogOut, MessageCircle,
} from "lucide-react";

const NAV_ITEMS = [
  { label: "Dashboard",     path: "/hospital-admin/dashboard",     iconName: "LayoutDashboard" },
  { label: "Employees",     path: "/hospital-admin/employees",     iconName: "Users" },
  { label: "Departments",   path: "/hospital-admin/departments",   iconName: "Building2" },
  { label: "Attendance",    path: "/hospital-admin/attendance",    iconName: "UserCheck" },
  { label: "Shifts",        path: "/hospital-admin/shifts",        iconName: "Calendar" },
  { label: "Leave",         path: "/hospital-admin/leave",         iconName: "Clock" },
  { label: "Payroll",       path: "/hospital-admin/payroll",       iconName: "DollarSign" },
  { label: "Reports",       path: "/hospital-admin/reports",       iconName: "FileText" },
  { label: "Notifications", path: "/hospital-admin/notifications", iconName: "Bell", badge: 3 },
  { label: "Devices",       path: "/hospital-admin/devices",       iconName: "Cpu" },
  { label: "Settings",      path: "/hospital-admin/settings",      iconName: "Settings" },
];
